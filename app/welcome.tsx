...
const SLIDES = [
  {
    ...
    subtitle:
      "Turn every walk, run, and ride into an adventure worth remembering.",
  },
  {
    id: "routes",
    theme: "light",
    ...
    subtitle:
      "Log your runs, walks, hikes, and cycles. Every route saved to your logbook.",
  },
  {
    id: "xp",
    theme: "light",
    title: "Earn XP,\nunlock badges",
    subtitle:
      "Every km earns points. Level up, collect badges, and build your streak.",
  },
  {
    id: "ready",
    theme: "night",
...
export default function WelcomeScreen() {
  ...
  useEffect(() => {
    ...
    timeoutRef.current = setTimeout(
      ...
      stepIndex === SLIDES.length - 1 ? 2800 : 2500,
              ...
              return (
                <View
                  ...
                  style={[
                    ...
                    active
                      ? darkDot
                        ? styles.dotLightActive
                        : styles.dotDarkActive
                      : undefined,
                  ]}
                />
              );
            ...
            <>
              <View style={styles.demoCard}>
                ...
                <View style={styles.xpBarTrack}>
                  <Animated.View
                    style={[styles.xpBarFill, { width: xpWidth }]}
                  />
                </View>
  ...
  return (
    ...
    >
      <Text
        style={[
          styles.badgeEmoji,
          earned ? undefined : styles.badgeEmojiLocked,
        ]}
      >
        {emoji}
      </Text>
      <Text
        style={[
          styles.badgeLabel,
          earned ? styles.badgeLabelEarned : styles.badgeLabelLocked,
        ]}
      >
        {label}
      </Text>
